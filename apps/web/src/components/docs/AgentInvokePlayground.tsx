          ...
          <div>
            ...
            {response.status === 202 && (
              <p style={{ marginTop: 8, fontSize: '0.8125rem', color: '#6b7280' }}>
                Run started. Use the <code style={{ background: '#f1f0ff', color: '#534AB7', padding: '0.1em 0.4em', borderRadius: 4 }}>run_id</code> above
                with <code style={{ background: '#f1f0ff', color: '#534AB7', padding: '0.1em 0.4em', borderRadius: 4 }}>GET /runs/:id</code> to poll for results.
              </p>
            )}
          </div>
        )}
