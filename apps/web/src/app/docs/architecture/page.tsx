...
export default function ArchitecturePage() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Toolbar */}
      <div className="flex items-center justify-between gap-3 px-4 sm:px-6 py-3 border-b border-border bg-surface flex-shrink-0 flex-wrap">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            onClick={zoomOut}
            className="p-1.5 rounded-lg border border-border-strong hover:bg-muted text-muted-foreground"
            title="Zoom out"
          >
            <ZoomOut className="w-4 h-4" />
          </button>
          <span className="text-[12px] text-muted-foreground w-10 text-center">{zoom}%</span>
          <button
            onClick={zoomIn}
            className="p-1.5 rounded-lg border border-border-strong hover:bg-muted text-muted-foreground"
            title="Zoom in"
          ...
          <button
            onClick={reset}
            className="p-1.5 rounded-lg border border-border-strong hover:bg-muted text-muted-foreground ml-1"
            title="Reset zoom"
          >
