...
export default function WorkflowsPage() {
  ...
  return <div className="p-6">
    ...
    {isLoading && <div className="py-12 text-center text-sm text-gray-400">Loading workflows…</div>}
        ...
        <div key={wf.id} className="bg-white border border-gray-100 rounded-xl p-4">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-[11px] text-gray-400 mt-1">{wf.description || `${wf.mode} workflow`}</p>
            </div>
