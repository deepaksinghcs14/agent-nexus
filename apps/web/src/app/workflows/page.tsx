  ...
  return <div className="p-4 sm:p-6">
    <div className="flex flex-wrap items-center gap-3 justify-between mb-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Pipeline and supervisor multi-agent workflows</p>
      </div>
      <Link href="/workflows/new" className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-accent text-white text-[12px] rounded-lg">
