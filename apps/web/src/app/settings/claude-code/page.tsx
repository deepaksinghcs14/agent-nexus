...
// pipeline (Claude account, GitHub token). Encrypted at rest, injected per
// coding session — a workspace GitHub token takes precedence over any
// instance-level GITHUB_TOKEN env. Everything else (repo allowlist,
// readiness, session activity) lives on the Claude Code nav page. Jira
// ticket access itself goes through the MCP Atlassian preset, not a
// dedicated credential here.
