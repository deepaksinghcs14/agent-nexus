...
export default function NewAgentGroupPage() {
  ...
  const create = useMutation({
    mutationFn: () => groupsAPI.create({ name, description, mode }) as Promise<AgentGroup>,
    onSuccess: (group: AgentGroup) => router.push(`/agent-groups/${group.id}`),
  ...
  return (
    <div className="p-6 max-w-2xl">
      <div className="mb-6">
        <h1 className="text-lg font-semibold text-gray-900">Create Agent Group</h1>
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-6 space-y-4">
        ...
        <div className="pt-2 flex gap-2 justify-end">
          <Link href="/agent-groups" className="px-4 py-2 text-sm text-gray-600 border border-gray-200 rounded-lg">
            Cancel
          </Link>
          <button
